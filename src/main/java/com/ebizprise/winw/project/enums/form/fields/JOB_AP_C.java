...
public enum JOB_AP_C implements FormFields {
    ...
    JOB_16(216, "form.search.column.countersigneds", SELECT, "apcCountersigneds"),
    JOB_27(228, "form.job.form.countersigneds", INPUT, "countersigneds"),
    ...
    JOB_19(219, "form.search.column.job.date.offLineTime", DATE_RANGE, "offLineTime", true),
    ...
    JOB_23(223, "form.search.column.job.date.sct", DATE_RANGE, "sct"),
    ...
    JOB_28(247, "form.search.column.job.ap.isProgramOnline", SELECT, "isProgramOnline"),
...
// 測試Rebase    
    private static final Map<String, JOB_AP_C> BY_INDEX = new HashMap<String, JOB_AP_C>();
    private static final Map<String, JOB_AP_C> BY_VONAME = new HashMap<String, JOB_AP_C>();
    ...
    private JOB_AP_C (int index, String name, String type) {
        this.index = index;
        this.name = name;
        this.type = type;
    }

    private JOB_AP_C (String name, String type, String voName) {
        this.name = name;
        this.type = type;
        this.voName = voName;
    }
    
    private JOB_AP_C (int index, String name, String type, int length) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.length = length;
    ...
    private JOB_AP_C (int index, String name, String type, String voName) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.voName = voName;
    ...
    private JOB_AP_C (int index, String name, String type, String voName, boolean isDefaultCol) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.voName = voName;
