 ...
 * @author adam.yeh
 */
public enum AP implements FormFields {
    ...
    private static final Map<String, AP> BY_INDEX = new HashMap<String, AP>();
    private static final Map<String, AP> BY_VONAME = new HashMap<String, AP>();
    ...
    public static AP valueOfNumber (String number) {
    ...
    private AP (int index, String name, String type) {
        this.index = index;
        this.name = name;
        this.type = type;
    }
    
    private AP (int index, String name, String type, int length) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.length = length;
    ...
    private AP (int index, String name, String type, String voName) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.voName = voName;
    ...
    private AP (int index, String name, String type, String voName, boolean isDefaultCol) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.voName = voName;
