 ...
 * @author adam.yeh
 */
public enum PT implements FormFields {
    ...
    private static final Map<String, PT> BY_INDEX = new HashMap<String, PT>();
    private static final Map<String, PT> BY_VONAME = new HashMap<String, PT>();
    ...
    public static PT valueOfNumber (String number) {
    ...
    private PT (int index, String name, String type) {
        this.index = index;
        this.name = name;
        this.type = type;
    }
    
    private PT (int index, String name, String type, int length) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.length = length;
    ...
    private PT (int index, String name, String type, String voName) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.voName = voName;
    ...
    private PT (int index, String name, String type, String voName, boolean isDefaultCol) {
        this.index = index;
        this.name = name;
        this.type = type;
        this.voName = voName;
