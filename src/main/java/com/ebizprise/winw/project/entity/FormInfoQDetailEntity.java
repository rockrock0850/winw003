 ...
 */
@Entity
@Table(name = "FORM_INFO_Q_DETAIL")
public class FormInfoQDetailEntity extends BaseEntity {
    ...
    private String questionPriorityWording;
    ...
    @Basic
    @Column(name = "QuestionPriorityWording")
    ...
    public boolean equals(Object o) {
        ...
        FormInfoQDetailEntity that = (FormInfoQDetailEntity) o;
        return id == that.id && Objects.equals(formId, that.formId) && Objects.equals(summary, that.summary)
                ...
                && Objects.equals(system, that.system) && Objects.equals(assetGroup, that.assetGroup)
                && Objects.equals(effectScope, that.effectScope) && Objects.equals(urgentLevel, that.urgentLevel)
                && Objects.equals(questionPriority, that.questionPriority)
                ...
                && Objects.equals(questionPriorityWording, that.questionPriorityWording)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, formId, summary, content, cCategory, cClass, cComponent, sClass, sSubClass, system,
                assetGroup, effectScope, urgentLevel, questionPriority, countersigneds, systemId,this.getUpdatedBy(),
                this.getUpdatedAt(), this.getCreatedBy(), this.getCreatedAt(), effectScopeWording, urgentLevelWording, questionPriorityWording);
    }
