 ...
 */
@Entity
@Table(name = "FORM_PROCESS_DETAIL_APPLY_Q")
public class FormProcessDetailApplyQEntity extends BaseEntity {
	...
	public boolean equals(Object o) {
		...
		FormProcessDetailApplyQEntity that = (FormProcessDetailApplyQEntity) o;
