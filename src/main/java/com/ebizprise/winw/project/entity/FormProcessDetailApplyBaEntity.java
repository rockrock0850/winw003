...
/**
 * @author Bernard.Yu 2020/10/29
 */
@Entity
@Table(name = "FORM_PROCESS_DETAIL_APPLY_BA")
public class FormProcessDetailApplyBaEntity extends BaseEntity {
	...
	public boolean equals(Object o) {
		...
		FormProcessDetailApplyBaEntity that = (FormProcessDetailApplyBaEntity) o;
