 ...
 */
@Entity
@Table(name = "FORM_PROCESS_DETAIL_APPLY_SR")
public class FormProcessDetailApplySrEntity extends BaseEntity {
	...
	public boolean equals(Object o) {
		...
		FormProcessDetailApplySrEntity that = (FormProcessDetailApplySrEntity) o;
