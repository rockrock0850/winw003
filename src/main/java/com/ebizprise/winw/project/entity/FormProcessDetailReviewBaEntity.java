 ...
 */
@Entity
@Table(name = "FORM_PROCESS_DETAIL_REVIEW_BA")
public class FormProcessDetailReviewBaEntity extends BaseEntity {
	...
	public boolean equals(Object o) {
		...
		FormProcessDetailReviewBaEntity that = (FormProcessDetailReviewBaEntity) o;
