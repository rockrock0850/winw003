 ...
 */
@Entity
@Table(name = "FORM_PROCESS_DETAIL_REVIEW_INC")
public class FormProcessDetailReviewIncEntity extends BaseEntity {
	...
	private String  isAddQuestionIssue;
	...
	@Basic
    @Column(name = "IsAddQuestionIssue")
	...
	public boolean equals(Object o) {
		...
		FormProcessDetailReviewIncEntity that = (FormProcessDetailReviewIncEntity) o;
		return id == that.id && processOrder == that.processOrder && Objects.equals(processId, that.processId)
				...
				&& Objects.equals(isAddQuestionIssue, that.isAddQuestionIssue)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, detailId, processId, processOrder, groupId, nextLevel, backLevel,isAddQuestionIssue,isModifyColumnData,isCloseForm,isWaitForSubIssueFinish, this.getUpdatedBy(),
