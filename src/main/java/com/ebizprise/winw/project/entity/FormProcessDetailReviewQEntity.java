 ...
 */
@Entity
@Table(name = "FORM_PROCESS_DETAIL_REVIEW_Q")
public class FormProcessDetailReviewQEntity extends BaseEntity {
	...
	public boolean equals(Object o) {
		...
		FormProcessDetailReviewQEntity that = (FormProcessDetailReviewQEntity) o;
