 ...
 */
@Component
public class SRCValidateColHelper extends BaseFormValidateHelper implements FormColumnValidate {
    ...
    public List<String> initColumns (CommonFormVO vo) {
        return Arrays.asList(UnEditableEnum.SR_C.columns());
    }
    ...
    public List<String> proposeColumns (CommonFormVO vo, SysUserVO userInfo) {
        ...
        if (isCreator(vo, userInfo)) {
            columns.addAll(
                    Arrays.asList(UnEditableEnum.SR_C.columns()));
        } else {
    ...
    public List<String> applyColumns (CommonFormVO vo, SysUserVO userInfo) {
        ...
        if (isVerifyAcceptable) {
            ...
            if (isApplyLevelOne(vo, userInfo)) {
                columns.addAll(Arrays.asList(EditOneEnum.SR_C.columns()));
            }
            ...
            if (!isApprover(vo)) {
                ...
                if (isModifyColumnData) {
                    columns.addAll(Arrays.asList(EditableEnum.SR_C.columns()));
                }
            }
        }
