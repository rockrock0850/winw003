 ...
 */
public class AuditInformSRJob extends QuartzJobFactory implements AuditInform {
    ...
    public String executeJob(JobExecutionContext jec) throws Exception {
        ...
        List<AuditNotifyParamsEntity> anParams = service.getANParams(FormVerifyType.SR.name());
    ...
    public List<AuditInformVO> getAuditFormList () throws Exception {
        ResourceEnum resource = ResourceEnum.SQL_FORM_OPERATION_SR.getResource("FIND_SR_AUDIT_INFORM");
