 ...
 */
public class AuditInformIncHoursJob extends QuartzJobFactory implements AuditInform {
    ...
    public String executeJob(JobExecutionContext jec) throws Exception {
        ...
        List<AuditNotifyParamsEntity> anParams = service.getANParams(FormVerifyType.INCH.name());
