...
/**
 * @author gary.tsai 2019/11/7
 */
@Service("jobSPCFormService")
public class JobSPCFormServiceImpl extends BaseFormService<CountersignedFormVO> implements IBaseCountersignedFormService<CountersignedFormVO> {
    @Autowired
