 ...
 * 
 * @author suho.yeh
 * @version 1.0, Created at 2019年8月18日
 */
@Service("qCloseOnTimeInTargetFinishYMService")
public class QCloseOnTimeInTargetFinishYMServiceImpl extends BaseReportOperationService{

    @Override
    public String getUrl() {
        setUrl(ReportOperationEnum.Q_CLOSE_ON_TIME_IN_TARGET_FINISH_Y_M.getPath());
        return pageUrl;
    }
    
    @Override
    public void setReportOperationVO(ReportOperationVO reportOperation) {
        setNotExists(ReportOperationEnum.Q_CLOSE_ON_TIME_IN_TARGET_FINISH_Y_M.getValue());
        setResourceEnum(ResourceEnum.SQL_REPORT_OPERATION_Q.getResource(
                ReportOperationEnum.Q_CLOSE_ON_TIME_IN_TARGET_FINISH_Y_M.getSqlFileName())); 
    ...
    public void setDataSet(Collection<Object> dataSet, ReportOperationVO reportOperation) {
        ...
        dataSet.add(new ExcelModel(StringConstant.PARAM_TITLEM
                ,getMessage(ReportOperationEnum.Q_CLOSE_ON_TIME_IN_TARGET_FINISH_Y_M.getI18n())
