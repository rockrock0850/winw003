 ...
 */
@Service("sRSuccessRateService")
public class SRSuccessRateServiceImpl extends BaseReportOperationService{
    private static final String A = "(A)";
    private static final String B = "(B)";
    private static final String C = "(C)";
    @Override
    public String getUrl() {
        setUrl(ReportOperationEnum.SR_SUCCESS_RATE.getPath());
        return pageUrl;
    }
    
    @Override
    public void setReportOperationVO(ReportOperationVO reportOperation) {
        setNotExists(ReportOperationEnum.SR_SUCCESS_RATE.getValue());
        setResourceEnum(ResourceEnum.SQL_REPORT_OPERATION_SR
                .getResource(ReportOperationEnum.SR_SUCCESS_RATE.getSqlFileName()));
        ...
        Map<String,List<Map<String,Object>>> resultDataList = new LinkedHashMap<String,List<Map<String,Object>>>();
    ...
    public void setDataSet(Collection<Object> dataSet, ReportOperationVO reportOperation) {
        ...
        dataSet.add(new ExcelModel(StringConstant.PARAM_TITLEM
                ,getMessage(ReportOperationEnum.SR_SUCCESS_RATE.getI18n())
        ...
        if (detailList != null) {
            for (String key : detailList.keySet()) {
                dataSet.add(
                        new ExcelModel(StringConstant.PARAM_TITLE,
                        key,
                        StringConstant.PARAM_MERGE_COLUMNS+StringConstant.PAPAM_1));
                ...
                // 資料行
                int i = 0;
                for (Map<String,Object> m : detailList.get(key)) {
                    i = 0;
