SELECT ori.formId, ori.userCreated, ori.summary, ori.content, ori.ect, ori.createTime, ori.formClass, ori.createName,
ori.solvingName, ori.userSolving, ori.divisionSolving, ori.detailID, fvl_2.verifyLevel, fvl_2.verifyType FROM (
	SELECT
	F.formId,
	FISRD.summary,
	FISRD.content,
...
FROM
	form F
JOIN 
	form_info_sr_detail FISRD ON  F.formid = FISRD.formId
LEFT JOIN 
