...
$(function () {
	$('#searchBtn').click(function(){
		...
		vos.operation = 'qStatisticSource';
					...
					if(count > 1){
						...
						$.each(values,function(k,v){
							...
							$.each(v,function(k1,v1){
								if(v1=='total'){
									html +='<td><s:message code="report.operation.q.source.total" text="" /></td>';
								}else{
									if(k1==0){
	...
	$('#exportBtn').click(function(){
		...
		var postData = {};
		postData["operation"] = 'qStatisticSource';
...
<%@ include file="/WEB-INF/jsp/layout/header.jsp"%>	
	<h1><s:message code="report.operation.title.q.statisticSource" text='問題單來源數量統計表' /></h1>
	...
	<div style="display:none">
		<table id="cloneTableTitle" class="grid_list" style="width: 100%">
			<thead>
				<tr>
					<th width="40%"><s:message code="report.operation.q.form.source" text='' /></th>
					<th width="60%"><s:message code="report.operation.q.form.num" text='' /></th>						
				</tr>
			</thead>
			<tbody>
			</tbody>			
