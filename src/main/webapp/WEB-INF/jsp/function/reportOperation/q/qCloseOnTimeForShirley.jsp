...
var saveRemoveId = [];
	$(function () {
		$('#searchBtn').click(function(){
			...
			vos.operation = 'qCloseOnTimeForShirley';
		...
		$('#exportBtn').click(function(){
			...
			var postData = {};
			postData["operation"] = 'qCloseOnTimeForShirley';
...
<%@ include file="/WEB-INF/jsp/layout/header.jsp"%>	
	<h1><s:message code="report.operation.title.q.closeOnTimeForShirley" text='問題處理完成率(含特殊結案)' /></h1>
	...
	<fieldset class="search">
		...
		<p><s:message code="q.report.operation.description.content.6" text='已解決的問題單數量(B)：預計完成年月日>=實際完成年月日，' />
		   <s:message code="q.report.operation.description.content.7" text='且問題單需科長核可，含「特殊結案已結案」與「特殊結案待追蹤」，' />
