...
<script>//# sourceURL=incStatisticReportIDC.js
var timeIdList = [];
var request, machineList;
...
function initEvent () {
	$('#searchBtn').click(function () {
		...
		request.operation = 'iNCStatisticReportIDC';
...
<%@ include file="/WEB-INF/jsp/layout/header.jsp"%>	
	<h1><s:message code="report.operation.title.inc.statisticReportIDC" text='事件單機房事件統計表' /></h1>
	<form id='recordForm'>
	...
	<fieldset id='detail' class='hidden'>
		<legend>各科未結案事件單追蹤統計表 (機房事件明細)</legend>
		<table id="detailList" class="grid_list">
			<thead></thead>
			<tbody></tbody>
		</table>
	</fieldset>
