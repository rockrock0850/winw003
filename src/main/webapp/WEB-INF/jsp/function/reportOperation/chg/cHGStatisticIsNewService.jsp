...
$(function () {
	$('#searchBtn').click(function(){
		...
		vos.operation = 'cHGStatisticIsNewService';
	...
	$('#exportBtn').click(function(){
		...
		var postData = {};
		postData["operation"] = 'cHGStatisticIsNewService';
...
<%@ include file="/WEB-INF/jsp/layout/header.jsp"%>	
	<h1><s:message code="report.operation.title.chg.statisticIsNewService" text='各科對應新服務暨重大服務變更類型統計表' /></h1>
	...
	<div style="display:none">
		<table id="cloneTableTitle" class="grid_list" style="width: 50%">
			<thead>
				<tr>
					<th width="25%"><s:message code="report.operation.department" text='' /></th>
					<th width="75%"><s:message code="report.operation.chg.newService" text='' /></th>						
				</tr>
			</thead>
			<tbody>
			</tbody>			
