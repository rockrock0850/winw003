...
$(function () {
	$('#searchBtn').click(function(){
		...
		vos.operation = 'cHGStatisticLevel';
	...
	$('#exportBtn').click(function(){
		...
		var postData = {};
		postData["operation"] = 'cHGStatisticLevel';
...
<%@ include file="/WEB-INF/jsp/layout/header.jsp"%>	
	<h1><s:message code="report.operation.title.chg.statisticLevel" text='各科對應各等級變更類型統計表' /></h1>
		...
		<table id="cloneTableTitle" class="grid_list" style="width: 50%">
			<thead>
				<tr align="center">
					...
					<th><s:message code="report.operation.chg.secondary.change" text='次要變更' /></th>
				<th colspan="2"><s:message code="report.operation.chg.important.change" text='重大變更' /></th>
				</tr>
				<tr align="center">
					<th><s:message code="report.operation.chg.not.newSystem" text='非新系統' /></th>
					<th><s:message code="report.operation.chg.not.newSystem" text='非新系統' /></th>
					<th><s:message code="report.operation.chg.new.system" text='新系統' /></th>
				</tr>				
			</thead>
			<tbody>
			</tbody>			
