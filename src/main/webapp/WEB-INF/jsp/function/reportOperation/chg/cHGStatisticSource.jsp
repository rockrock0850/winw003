...
$(function () {
	$('#searchBtn').click(function(){
		...
		vos.operation = 'cHGStatisticSource';
	...
	$('#exportBtn').click(function(){
		...
		var postData = {};
		postData["operation"] = 'cHGStatisticSource';
...
<%@ include file="/WEB-INF/jsp/layout/header.jsp"%>	
	<h1><s:message code="report.operation.title.chg.statisticSource" text='各變更單來源統計表' /></h1>
	...
	<div style="display:none">
		<table id="cloneTableTitle" class="grid_list" style="width: 100%">
			<thead>
				<tr>
					<th width="40%"><s:message code="report.operation.form.type.code" text='' /></th>
					<th width="30%"><s:message code="report.operation.form.type" text='' /></th>
					<th width="30%"><s:message code="report.operation.form.wonum" text='' /></th>						
				</tr>
			</thead>
			<tbody>
			</tbody>			
