			...
			<table class="grid_list" id="reportList">
				...
				<tbody id="applyProcessTable">
					<tr align="center">
						...
						<td>
							<input id="isModifyColumnData" type="checkbox" /><!-- 可修改欄位資料 -->
						</td>
						<td>
			...
			<table class="grid_list" id="reportList1">
				...
				<tbody id="reviewProcessTable">
					<tr align="center">
						...
						<td>
							<input id="isCloseForm" type="checkbox" /><!-- 可否直接結案 -->
						</td>
						<td>
							<input id="isApprover" type="checkbox" /><!-- 是否為審核者 -->
						</td>
...
function saveProcess() {
	...
	//Insert
	SendUtil.post('/formProcessManagmentChg/insertFormProcess', mainParams, function (data) {
