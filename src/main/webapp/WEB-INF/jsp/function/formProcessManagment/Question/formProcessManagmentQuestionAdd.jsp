		...
		<div>
			<table class="grid_list" id="reportList">
				<tr align="center">
					...
					<c:if test="${isCountersign != 'Y'}">
						<th>
							<s:message code="form.process.managment.column.is.create.q.c.issue" text="可否產生會辦單	"/>
						</th>
					</c:if>
					<th>
...
function saveProcess() {
	...
	//Insert
	SendUtil.post('/formProcessManagmentQuestion/insertFormProcess', mainParams, function (data) {
