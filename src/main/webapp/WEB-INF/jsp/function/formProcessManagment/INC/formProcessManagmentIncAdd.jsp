        ...
        <table class="grid_list" id="reportList">
            <tr align="center">
                ...
                <c:if test="${isCountersign != 'Y'}">
                    <th>
                        <s:message code="form.process.managment.column.is.create.inc.c.issue" text="可否產生事件會辦單" />
                    </th>
                </c:if>
                <th>
    ...
    <div>
        <table class="grid_list" id="reportList1">
            ...
            <tr align="center">
                ...
                <c:if test="${isCountersign != 'Y'}">
                    <td><input id="isAddQuestionIssue" type="checkbox" /></td>
                </c:if>
...
<script>
    ...
    function createApplyFormDetail() {
        ...
        applyObjStr = applyObjStr +  '<td><span class="applyProcessOrderText currentLevel"></span></td>'
    ...
    function saveProcess() {
        ...
        //Insert
        SendUtil.post('/formProcessManagmentInc/insertFormProcess', mainParams, function (data) {
