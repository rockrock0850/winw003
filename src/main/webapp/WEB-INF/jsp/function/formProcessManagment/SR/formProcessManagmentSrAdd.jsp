...
function createApplyFormDetail() {
	...
	let applyObjStr = '<tr align="center">';
		...
		if(isCountersign()) {
			...
			applyObjStr = applyObjStr + '<td custom="parallelCols" ' + isDisplay + '><button id="parallelButton" type="button" onclick="parallelButton();" style="display:none"><i class="iconx-add"></i>編輯</button></td>'
		}
...
function saveProcess() {
	...
	//Insert
	SendUtil.post('/formProcessManagmentSr/insertFormProcess', mainParams, function (data) {
