...
<script>
var getUrl = "/commonJobForm/getEaDetail";
var saveUrl = "/commonJobForm/saveEaDetail";
var tabType = '<c:out value="${tabType}"/>';

$(function () {
    $('input#division').val(tabType);
    DateUtil.dateTimePicker();
	fillCForm('tabEaForm', 'EA');
    authViewControl();
});
</script>

<fieldset>
	<legend><s:message code="form.countersigned.form.EA" text="電子商務科工作單(二)" /></legend>
	<form id="tabEaForm">
